...
def parse_args():
    ...
    # Model save path
    parser.add_argument("--save_path", type=str, default="/SAN/medic/Surgical_LLM_Agent/11Respawn/New/Best-Models/GaLore-new/3e-7/r128/10-epoch", help="Path to save the best model")
    # Other parameters
    ...
    parser.add_argument("--best_model_path", type=str, default="/SAN/medic/Surgical_LLM_Agent/11Respawn/New/Best-Models/GaLore-new/3e-7/r128/10-epoch",
    ...
    parser.add_argument("--output_dir", type=str, default="/SAN/medic/Surgical_LLM_Agent/11Respawn/New/Results/GaLore-new/3e-7/r128/10-epoch",
