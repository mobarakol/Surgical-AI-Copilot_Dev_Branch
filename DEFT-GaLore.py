...
def parse_args():
    ...
    # 模型保存路径
    parser.add_argument("--save_path", type=str, default="/SAN/medic/Surgical_LLM_Agent/11Respawn/New/Best-Models/Enhanced-Energy/3e-7/r128/10-epoch", help="保存最佳模型的路径")
    # 其他参数
